 ...
 * <code>com.service.service.impl.PurchaseLocalServiceImpl</code> and
...
public class PurchaseLocalServiceUtil {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to <code>com.service.service.impl.PurchaseLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
     */
    ...
    public static List<com.service.model.Employee> findByPositionTypeIdCount(
            Long id) {

        return getService().findByPositionTypeIdCount(id);
    }
    ...
    public static Purchase updatePurchase(
            Long ElectronicsId, Long employeeId, java.util.Date purchaseDate,
            Long PurchaseTypeId) {

        return getService().updatePurchase(
                ElectronicsId, employeeId, purchaseDate, PurchaseTypeId);
    }
