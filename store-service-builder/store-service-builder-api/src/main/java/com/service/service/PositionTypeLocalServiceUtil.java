 ...
 * <code>com.service.service.impl.PositionTypeLocalServiceImpl</code> and
...
public class PositionTypeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.service.service.impl.PositionTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static PositionType addPositionType(Long id, String name) {
		return getService().addPositionType(id, name);
	}
