...
import com.service.exception.NoSuchElectronicsException;
import com.service.model.Electronics;
import com.service.service.ElectronicsLocalServiceUtil;
import com.service.service.persistence.ElectronicsPersistence;
import com.service.service.persistence.ElectronicsUtil;
...
public class ElectronicsPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newElectronics.setElectronics_count(RandomTestUtil.nextInt());
		...
		Assert.assertEquals(
			existingElectronics.getElectronics_count(),
			newElectronics.getElectronics_count());
		Assert.assertEquals(
	...
	protected OrderByComparator<Electronics> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"store_Electronics", "uuid", true, "electronicsId", true, "name",
			true, "electroTypeId", true, "price", true, "electronics_count",
			true, "inStock", true, "archive", true, "description", true);
	}
	...
	protected Electronics addElectronics() throws Exception {
		...
		electronics.setElectronics_count(RandomTestUtil.nextInt());
